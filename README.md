...
**Cause:** A browser extension (payment/UPI widget) injects scripts that trigger CSP warnings.  
**Fix:** This is harmless — ignore it. It does not affect your dashboard.
