...
def test_phase8b_builds_signal_trade_and_strategy_views():
    payload = {
        ...
        "trades": [{
            "id": "t1", "symbol": "NIFTY", "entry": 100, "exit": 110, "sl": 95, "pnl": 1000,
            "intelligence": {
                "direction": "BUY", "outcome": "WIN", "pnl_inr": 1000,
                "r_multiple": 2.0, "strategy": "Sweep", "has_stop": True, "has_exit": True,
            },
        }],
        "strategy_stats": [{
            "strategy": "Sweep", "trades": 1, "wins": 1, "losses": 0, "flat": 0,
            "win_rate_pct": 100.0, "pnl_inr": 1000, "expectancy_inr": 1000,
            "profit_factor": None, "avg_win_inr": 1000, "avg_loss_inr": 0,
        }],
    }
